 ...
 * notice how we have to create a namespace that is equal to the function we're assigning the export to
 export module 'jwt-decode' {
 function jwtDecode(token: string): any;
 namespace jwtDecode {}
 export = jwtDecode;
 }
 *
 * If you're prototying and you will fix the types later you can also export it as type any
 *
...
export var GoogleMapsLoader:any;
export var L:any;
export var AmCharts:any;
export var Chart:any;
export var Chartist:any;

// support NodeJS modules without type definitions

// Extra variables that live on Global that will be replaced by webpack DefinePlugin
export var ENV: string;
export var HMR: boolean;
export var System: SystemJS;
interface SystemJS {
