export const IMAGES_ROOT = 'client/assets/img/';
...
export const layoutPaths = {
  images: {
    ...
    //amMap: 'client/assets/img/theme/vendor/ammap/',
    //amChart: 'client/assets/img/theme/vendor/amcharts/dist/amcharts/images/'
  }
};
