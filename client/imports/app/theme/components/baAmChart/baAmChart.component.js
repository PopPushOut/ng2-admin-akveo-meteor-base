...
var BaAmChart = (function () {
    ...
    BaAmChart.prototype.ngOnInit = function () {
        custom_typings_1.AmCharts.themes.blur = this._baAmChartThemeService.getTheme();
    };
    BaAmChart.prototype.ngAfterViewInit = function () {
        var chart = custom_typings_1.AmCharts.makeChart(this._selector.nativeElement, this.baAmChartConfiguration);
    ...
    BaAmChart.prototype._loadChartsLib = function () {
        services_1.BaThemePreloader.registerLoader(new Promise(function (resolve, reject) {
            ...
            if (custom_typings_1.AmCharts.isReady) {
                resolve(amChartsReadyMsg);
            }
            else {
                custom_typings_1.AmCharts.ready(function () {
                    resolve(amChartsReadyMsg);
                });
            }
        }));
