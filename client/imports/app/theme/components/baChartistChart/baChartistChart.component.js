...
var baChartistChart_loader_1 = require("./baChartistChart.loader");
var BaChartistChart = (function () {
    ...
    BaChartistChart.prototype.ngAfterViewInit = function () {
        this.chart = new baChartistChart_loader_1.Chartist[this.baChartistChartType](this._selector.nativeElement, this.baChartistChartData, this.baChartistChartOptions, this.baChartistChartResponsive);
