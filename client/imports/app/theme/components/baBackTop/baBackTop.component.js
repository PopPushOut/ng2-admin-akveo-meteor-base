...
var BaBackTop = (function () {
    ...
    BaBackTop.prototype._onClick = function () {
        custom_typings_1.jQuery('html, body').animate({ scrollTop: 0 }, { duration: this.moveSpeed });
        return false;
    };
    BaBackTop.prototype._onWindowScroll = function () {
        var el = this._selector.nativeElement;
        window.scrollY > this.position ? custom_typings_1.jQuery(el).fadeIn(this.showSpeed) : custom_typings_1.jQuery(el).fadeOut(this.showSpeed);
    };
    return BaBackTop;
}());
__decorate([
