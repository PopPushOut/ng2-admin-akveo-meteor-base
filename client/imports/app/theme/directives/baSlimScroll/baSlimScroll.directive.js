...
var BaSlimScroll = (function () {
    ...
    BaSlimScroll.prototype._init = function () {
        custom_typings_1.jQuery(this._elementRef.nativeElement).slimScroll(this.baSlimScrollOptions);
    };
    BaSlimScroll.prototype._destroy = function () {
        custom_typings_1.jQuery(this._elementRef.nativeElement).slimScroll({ destroy: true });
    };
    return BaSlimScroll;
}());
__decorate([
